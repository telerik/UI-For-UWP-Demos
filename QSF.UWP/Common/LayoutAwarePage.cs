...
namespace QSF.Common
{
    ...
    public partial class LayoutAwarePage : Page
    {
        ...
        protected virtual void GoHome(object sender, RoutedEventArgs e)
        {
            ...
            if (this.Frame != null)
            {
                while (NavigationService.Instance.Frame.CanGoBack)
                {
                    NavigationService.Instance.Frame.GoBack();
                }
            }
        }
        ...
        protected virtual void GoBack(object sender, RoutedEventArgs e)
        {
            ...
            if (NavigationService.Instance.Frame != null && NavigationService.Instance.Frame.CanGoBack)
            {
                NavigationService.Instance.Frame.GoBack();
            }
        }
        ...
        protected virtual void GoForward(object sender, RoutedEventArgs e)
        {
            ...
            if (NavigationService.Instance.Frame != null && NavigationService.Instance.Frame.CanGoForward)
            {
                NavigationService.Instance.Frame.GoForward();
            }
        }
        ...
        public void StartLayoutUpdates(object sender, RoutedEventArgs e)
        {
            ...
            // VisualStateManager.GoToState(control, DetermineVisualState(Window.Current.Bounds.Width, Window.Current.Bounds.Height), false);
        }
